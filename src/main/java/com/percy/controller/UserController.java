...
import com.percy.service.MessageService;
import com.percy.util.IpUtil;
import com.percy.util.UploadImg;
import com.percy.util.Validate;
...
public class UserController {
    ...
    public String index(@Valid Message message,BindingResult result, Model model,
        ...
        message.setAddress(IpUtil.getIpAddress(message.getIp()));
